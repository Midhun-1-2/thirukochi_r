...
export const spring = {
  ...
  screen: { type: "spring", stiffness: 220, damping: 30, mass: 0.85 } as Transition,
  /** Cards, reveals, sheets. */
  soft: { type: "spring", stiffness: 210, damping: 30, mass: 0.8 } as Transition,
...
export const screenVariants: Variants = {
  ...
  animate: {
    ...
    y: 0,
    filter: "blur(0px)",
    transition: { ...spring.screen, filter: { duration: 0.34, ease: ease.luxe } },
  },
  exit: {
    opacity: 0,
    y: -14,
