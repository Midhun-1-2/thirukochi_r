...
export default function ResetDemo({ onReset }: ResetDemoProps) {
  ...
  return (
    <motion.button
      ...
      className="absolute right-2.5 z-[70] flex h-7 w-7 items-center justify-center rounded-full border border-[rgba(215,175,92,0.18)] bg-wine-950/80 text-champagne-dim/70 transition-colors hover:text-gold-200"
