  ...
  return (
    <AnimatePresence>
      {open && (
        <>
          {/*
            No frosting on the scrim: a backdrop filter across the whole
            viewport has to copy and blur everything behind it on every frame,
            and the atmosphere below never stops moving — which is what made
            the sheet crawl on a large window. Under this tint the 3px blur
            was not visible anyway.
          */}
          <motion.div
            className="absolute inset-0 z-40 bg-wine-950/80"
          ...
          <motion.div
            ...
            /* Mounted only while open, so the hint costs nothing at rest and
