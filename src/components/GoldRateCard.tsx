...
export default function GoldRateCard() {
  ...
  const price = useCountUp(active.price, formatRupeesExact, { duration: 1.4, delay: 0.35 });
  ...
  return (
    <GlassCard className="px-5 py-5" beamDelay={0}>
      ...
      <p
        ref={price as React.RefObject<HTMLParagraphElement>}
        className="mt-1.5 font-display text-[clamp(28px,7vw,34px)] leading-none text-metal-gold"
      />
