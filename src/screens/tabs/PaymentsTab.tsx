...
export default function PaymentsTab() {
  const paid = useCountUp(payments.paidThisYear, formatRupees, { duration: 1.6, delay: 0.25 });
  ...
  return (
    ...
    >
      ...
      <GlassCard className="px-6 py-7" beamDelay={0}>
        ...
        <p
          ref={paid as React.RefObject<HTMLParagraphElement>}
          className="mt-3 font-display text-[36px] leading-none text-metal-gold"
        />
